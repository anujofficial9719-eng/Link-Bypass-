...
bot_token = getenv("8312266453:AAFG9XyRFvz3UKFlu3RK9BISg_18bkwhMv4")
api_hash = getenv("f240eae7c60e8e30c17203ab0e052f7e") 
api_id = getenv("34724970")
app = Client("Bypass_anuj_bot",api_id=api_id, api_hash=api_hash,bot_token=bot_token)  
